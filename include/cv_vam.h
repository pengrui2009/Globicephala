...
/* Bsm message partii optional configuration. */
typedef struct _bsm_partii_optional_st
{


    /* Vehicle safety ext. */ 
    uint8_t vehicle_safety_ext  :1;
    
    uint8_t vehicle_eventflags  :1;
    uint8_t path_history        :1;
    uint8_t path_prediction     :1;
    uint8_t exterior_lights     :1;
    
}bsm_partii_optional_st, *bsm_partii_optional_st_ptr;

#define BSM_PARTII_OPTIANAL_ST_LEN    (sizeof(bsm_partii_optional_st))
...
/* Bsm optinal status. */
#define BSM_PARTII_OPTIONAL_YES    0x01
#define BSM_PARTII_OPTIONAL_NO     0x00
...
#define VAM_FLAG_RESERVED     (0x0008)
