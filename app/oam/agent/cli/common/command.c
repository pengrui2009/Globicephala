...
extern void install_dev_manage_cmd(void);
extern void install_net_cmd(void);
...
int g_debug;
extern void initLogModules(void);
extern void finiLogModules(void);
extern void add_log_enable(void);
...
extern void install_user_mng_cmd(void);
