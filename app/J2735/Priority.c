...
asn_dec_rval_t
Priority_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
Priority_encode_uper(asn_TYPE_descriptor_t *td,
...
static asn_per_constraints_t asn_PER_type_Priority_constr_1 GCC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_Priority = {
	...
	Priority_decode_xer,
	Priority_encode_xer,
	Priority_decode_uper,
	Priority_encode_uper,
