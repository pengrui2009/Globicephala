...
static asn_TYPE_member_t asn_MBR_RsaBody_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct RsaBody, msgCnt),
	...
	{ ATF_POINTER, 1, offsetof(struct RsaBody, timeStamp),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RsaBody, typeEvent),
	...
	{ ATF_POINTER, 6, offsetof(struct RsaBody, description),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
	...
	{ ATF_POINTER, 5, offsetof(struct RsaBody, priority),
	...
	{ ATF_POINTER, 4, offsetof(struct RsaBody, heading),
	...
	{ ATF_POINTER, 3, offsetof(struct RsaBody, extent),
	...
	{ ATF_POINTER, 2, offsetof(struct RsaBody, position),
	...
	{ ATF_POINTER, 1, offsetof(struct RsaBody, furtherInfoID),
...
static int asn_MAP_RsaBody_oms_1[] = { 1, 3, 4, 5, 6, 7, 8 };
static ber_tlv_tag_t asn_DEF_RsaBody_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_RsaBody_tag2el_1[] = {
...
static asn_SEQUENCE_specifics_t asn_SPC_RsaBody_specs_1 = {
	sizeof(struct RsaBody),
	offsetof(struct RsaBody, _asn_ctx),
	asn_MAP_RsaBody_tag2el_1,
	9,	/* Count of tags in the map */
	asn_MAP_RsaBody_oms_1,	/* Optional members */
	7, 0,	/* Root/Additions */
	8,	/* Start extensions */
	10	/* Stop extensions */
};
asn_TYPE_descriptor_t asn_DEF_RsaBody = {
	"RsaBody",
	"RsaBody",
	SEQUENCE_free,
	SEQUENCE_print,
	...
	0,	/* Use generic outmost tag fetcher */
	asn_DEF_RsaBody_tags_1,
	sizeof(asn_DEF_RsaBody_tags_1)
		/sizeof(asn_DEF_RsaBody_tags_1[0]), /* 1 */
	asn_DEF_RsaBody_tags_1,	/* Same as above */
	sizeof(asn_DEF_RsaBody_tags_1)
		/sizeof(asn_DEF_RsaBody_tags_1[0]), /* 1 */
	0,	/* No PER visible constraints */
	asn_MBR_RsaBody_1,
	9,	/* Elements count */
	&asn_SPC_RsaBody_specs_1	/* Additional specs */
};
