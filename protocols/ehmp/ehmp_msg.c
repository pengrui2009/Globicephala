/*****************************************************************************
 ...
 @history:
           ...
           2017-11-30     wangxianwen Optimize the strucutrue.
           ...
******************************************************************************/
#include "stdint.h"
...
/* Ehmp source ID that indicate the manager. */
//static uint8_t EhmpSrcID = 0;
...
*    说明:    无
******************************************************************************/
int decode_v2x_msg(ehmp_msgtype_en_ptr msgtype_ptr, void *info_ptr, uint8_t *data_ptr, uint16_t data_len)
{
    int result = 0;
    uint8_t msg_id = 0;
...
*    说明:    无
******************************************************************************/
static int decode_dsrc_msg(ehmp_msgtype_en_ptr msgtype_ptr, msg_decode_wsmp_payload_info_st_ptr info_ptr, uint8_t *data_ptr, uint16_t data_len)
{
    int result = 0;
...
*    说明:    无
******************************************************************************/
static int decode_gps_msg(ehmp_msgtype_en_ptr msgtype_ptr, void *info_ptr, uint8_t *data_ptr, uint16_t data_len)
{
    int result = 0;
    uint8_t msgtype = 0;
...
*
*END*********************************************************************/
int ehmp_decode(ehmp_msgtype_en_ptr msgtype_ptr, void *info_ptr, uint8_t *data_ptr, uint16_t data_len)
{
    int                         ret = 0x00;
...
int ehmp_encode(ehmp_msgtype_en msgtype, void *info_ptr, uint8_t *data_ptr, uint16_t *len_ptr)
{
    int result = 0;
    frame_msg_header_st_ptr msg_ptr = NULL;
