...
asn_TYPE_member_t asn_MBR_BasicSafetyMessage_1[] = {
    ...
    { ATF_NOFLAGS, 0, offsetof(struct BasicSafetyMessage, id),
        ...
        0,
        { 0, &asn_PER_memb_id_constr_3,  memb_id_constraint_1 },
        0, 0, /* No default value */
        "id"
        },
    { ATF_POINTER, 1, offsetof(struct BasicSafetyMessage, plateNo),
        (ASN_TAG_CLASS_CONTEXT | (2 << 2)),
        -1,    /* IMPLICIT tag at current level */
        &asn_DEF_OCTET_STRING,
        0,
        { 0, &asn_PER_memb_plateNo_constr_4,  memb_plateNo_constraint_1 },
        0, 0, /* No default value */
        "plateNo"
        },
    ...
    { ATF_NOFLAGS, 0, offsetof(struct BasicSafetyMessage, accuracy),
    ...
    { ATF_POINTER, 1, offsetof(struct BasicSafetyMessage, safetyExt),
...
static const int asn_MAP_BasicSafetyMessage_oms_1[] = { 2, 9, 10, 15 };
